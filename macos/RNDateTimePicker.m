...
{
  if (_onChange) {
    _onChange(@{ @"timestamp": @(self.dateValue.timeIntervalSince1970 * 1000.0), @"utcOffset": @([self.timeZone secondsFromGMTForDate:self.dateValue] / 60 )});
  }
}
...
- (void)setDate:(NSDate *)date {
    ...
    if (![self.dateValue isEqualToDate:date]) {
