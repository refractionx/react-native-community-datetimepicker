...
- (void)setMode:(NSDatePickerMode)mode {
  _mode = mode;
  YGNodeMarkDirty(self.yogaNode);
}


- (void)setDisplayIOS:(NSDatePickerStyle)displayIOS {
...
//      [shadowPickerView.picker
//       setPref
//       setPreferredDatePickerStyle:shadowPickerView.displayIOS];
//    }
